...
library ValidationLogic {
     ...
     */
    function validateWithdraw(DataTypes.ReserveData storage reserveData, uint256 amount, uint256 userBalance)
        external
        view
    {
        require(amount != 0, Errors.VL_INVALID_AMOUNT);
    ...
    function validateBorrow(
        ...
        require(reserveData.aTokenAddress != address(0), Errors.VL_INVALID_RESERVE_ADDRESS);
        ...
        (vars.userCollateralBalance, vars.userBorrowBalance, vars.healthFactor) = GenericLogic.calculateLoanData(
            reserveAsset, reserveData, nftAsset, nftData, loanAddress, loanId, reserveOracle, nftOracle
        );
        ...
        require(
            vars.amountOfCollateralNeeded <= vars.userCollateralBalance, Errors.VL_COLLATERAL_CANNOT_COVER_NEW_BORROW
        );
    }
