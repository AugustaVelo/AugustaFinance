...
library ReserveLogic {
    ...
    function updateState(DataTypes.ReserveData storage reserve) internal {
        ...
        // totalDebtAccrued = (newVariableBorrowIndex - previousVariableBorrowInde) * scaledVariableDebt;
        // amountToMint = totalDebtAccrued * reserveFactor * 100 / 10000;
        // finalMint = amountToMint / newLiquidityIndex;
        _mintToTreasury(
            reserve,
            scaledVariableDebt,
    ...
    function init(
        ...
        reserve.aTokenAddress = bTokenAddress;
