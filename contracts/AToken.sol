 ...
 * @author Bend
 */
contract AToken is Initializable, IAToken, IncentivizedERC20 {
    ...
    modifier onlyLendPoolConfigurator() {
        require(msg.sender == address(_getLendPoolConfigurator()), Errors.LP_CALLER_NOT_LEND_POOL_CONFIGURATOR);
        _;
    }

    /**
     * @dev Initializes the aToken
     * @param addressProvider The address of the address provider where this Token will be used
     * @param treasury The address of the Bend treasury, receiving the fees on this aToken
     * @param underlyingAsset The address of the underlying asset of this aToken
     */
    function initialize(
        ...
        __IncentivizedERC20_init(aTokenName, aTokenSymbol, aTokenDecimals);
        ...
        emit Initialized(
            underlyingAsset, _addressProvider.getLendPool(), treasury, _addressProvider.getIncentivesController()
        );
    }
     ...
     *
     */
    function balanceOf(address user) public view override(ERC20Upgradeable, IERC20Upgradeable) returns (uint256) {
    ...
    /**
     * @dev Returns the address of the Bend treasury, receiving the fees on this aToken
     *
     */
