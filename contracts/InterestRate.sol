...
contract InterestRate is IInterestRate {
     ...
     *
     */
    uint256 public immutable OPTIMAL_UTILIZATION_RATE; //650000000000000000000000000
    ...
    function calculateInterestRates(
        ...
        availableLiquidity = availableLiquidity + (liquidityAdded) - (liquidityTaken); //当前可借资金
